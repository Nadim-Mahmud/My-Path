...
public class RoutingExample {
    public static void main(String[] args) {
        GraphHopper hopper = createGraphHopperInstance("src/main/resources/geofabrik/ohio-latest.osm.pbf");
        routing(hopper);
        speedModeVersusFlexibleMode(hopper);
        alternativeRoute(hopper);
        customizableRouting("src/main/resources/geofabrik/ohio-latest.osm.pbf");
